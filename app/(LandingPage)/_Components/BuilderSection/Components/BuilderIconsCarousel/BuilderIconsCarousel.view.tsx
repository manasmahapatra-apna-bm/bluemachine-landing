...
import type { BuilderIcon } from '../../Constants/BuilderIconsConstants';

interface BuilderIconsCarouselViewProps {
    icons: readonly BuilderIcon[];
    isCarouselMode: boolean;
    containerRef: React.RefObject<HTMLDivElement | null>;
}

export function BuilderIconsCarouselView({
    icons,
    isCarouselMode,
    containerRef,
